<template>
    <div>
        <header>
            <nav class="fixed top-0 left-0 z-20 w-full py-3 bg-black shadow-sm xl:py-2">
                <div
                    class="container flex flex-wrap items-center justify-between p-5 mx-auto md:text-lg md:font-semibold w-"
                >
