            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                >
                    <div class="relative w-full">
                        ...
                        <input
                            class="focus:ring-primary-500 focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-3 pl-10 text-sm text-gray-900 sm:rounded-none sm:rounded-l-lg"
                    ...
                    <div>
                        <button
                            ...
                            class="border-primary-600 hover:bg-primary-800 focus:ring-primary-300 w-full cursor-pointer rounded-lg border bg-sips-orange px-5 py-3 text-center text-sm font-medium text-white focus:ring-4 sm:rounded-none sm:rounded-r-lg"
                            :disabled="isSaving"
                        >
