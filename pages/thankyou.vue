<template>
    <div id="h-50" class="flex items-center">
        <div class="justify-center w-2/4 mx-auto text-center">
            ...
            <div class="mb-10">
                <p class="text-3xl leading-relaxed">
                    File Anda telah terkirim ke 
                    [nama email],
                    cek inbox dan selamat menambah insight digital marketing Anda. 
                </p>
            </div>
            <div class="mb-10">
                <p class="text-3xl leading-relaxed">
...
X X X                <!-- <SharedSocialShareButton class="mt-4 md:mt-5 lg:mt-7" :url="currentURL" :text="`Baca artikel`" /> -->
            </div>
            <h3 class="pt-5 mt-5 mb-8 text-xl font-bold text-sips-green xl:text-3xl hover:underline animate-pulse ">
