...
export default {
    ...
    async mounted() {
        ...
        useSeoMeta({
            ...
            twitterDescription: 'At SIPS Digital Creative, we specialize in custom solutions that turn your pharma goals into realities.',
            twitterImage: '/insights-sips-digital.webp',
            twitterCard: "Explore our success stories and see firsthand how we've helped our clients thrive.",
        });
