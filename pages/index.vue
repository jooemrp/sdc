<template>
	<div
		class="flex justify-center pt-24 mx-auto mt-20 bg-gradient-to-r from-sky-800 via-10% to-emerald-500 to-90% pb-16"
	>
		<div class="container grid xl:grid-cols-3">
			<div class="col-span-2 m-auto">
				...
				>
					<button
						class="px-5 py-3 mx-10 mt-5 text-xl text-white bg-orange-500 xl:px-12 hover:bg-orange-600 rounded-xl"
					>
						Contact Us
					</button>
				</a>
	...
	<div class="container py-12 mx-auto">
		<div class="grid-cols-2 m-5 space-y-10 xl:grid xl:my-10">
			<div class="row-span-6">
				...
				<h2
					class="text-5xl font-bold text-orange-500 xl:mt-10 xl:text-6xl"
				>
	...
	<div class="py-20 mx-auto mt-5 bg-sips-maroon">
		...
		<div
			class="grid grid-cols-2 gap-8 px-5 py-10 mx-5 my-16 mb-10 bg-white xl:mx-auto xl:w-3/4 xl:grid-cols-4 xl:gap-16 justify-items-center rounded-3xl"
		>
			<img
				class="xl:mt-5"
				src="/a-01.webp"
	...
	<div class="flex justify-center py-16 my-12 text-center">
		<div class="container px-2 xl:px-5">
			<h2
				class="mx-auto mb-12 text-3xl font-bold leading-normal xl:w-3/4 w:full xl:mx-auto text-sips-navy xl:text-5xl xl:leading-snug"
			>
			...
			>
				<button
					class="px-5 py-3 text-xl text-white bg-orange-500 xl:px-12 hover:bg-orange-600 rounded-xl"
				>
					Contact Us
				</button>
			</a>
	...
	<section class="flex justify-center py-16 mx-auto bg-sips-orange">
		<div class="container mx-10 md:mx-32 lg:mx-40">
			<h2
				class="mx-auto mb-12 text-3xl font-bold leading-normal xl:w-3/4 w:full xl:mx-auto text-white xl:text-5xl xl:leading-snug text-center"
			>
				Enhance Your Expertise with Valuable Insights and Resources
			</h2>

			<div
				class="grid-cols-1 mx-10 md:grid-cols-4 lg:grid bg-slate-50 shadow-lg rounded-sm"
			>
				<div class="p-5">
					<div v-for="item in contentItems">
						<div
							...
							class="content-item p-4 mx-auto my-1 text-black cursor-pointer hover:bg-slate-100 hover:border-r-4 hover:border-sips-orange"
						>
							{{ item.name }}
						</div>
					</div>
				...
				<div class="col-span-1 md:col-span-3 p-5">
					<div v-if="contents.length > 0">
						<div class="w-full overflow-x-auto whitespace-no-wrap flex ">
			...
			<div class="flex justify-center">
				<a href="#" target="_blank" class="mt-12">
					<button
						class="px-5 py-3 text-xl text-white bg-sips-maroon xl:px-12 rounded-xl"
					>
						Let's Talk
					</button>
				</a>
