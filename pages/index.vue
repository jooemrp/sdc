<template>
    <div
        class="mx-auto flex justify-center bg-gradient-to-r from-sky-800 via-10% to-emerald-500 to-90% pb-16 "
    >
        <div class="container grid xl:grid-cols-3">
            <div
                class="col-span-2 m-auto"
                data-aos="fade-right"
    ...
    <div class="flex justify-center py-20 text-center bg-blue-900 bg-center bg-cover xl:bg-texture bg-blend-color-burn">
        <div class="container px-2 xl:px-5">
            ...
            <a href="https://sipsedutech.id/en/about" target="_blank" >
                <button
                    class="px-8 py-3 text-xl text-white border-2 border-white rounded-xl hover:bg-white hover:text-black hover:font-semibold"
                >
                    More About Us
                </button>
            </a>
        ...
        <div class="grid-cols-2 m-5 space-y-10 xl:my-10 xl:grid">
            ...
            >
                ...
                <div class="max-w-xl pt-12">
                    ...
                    >
                        <p
                            class="max-w-xl py-5 text-2xl font-semibold text-blue-900 hover:text-blue-500 hover:underline"
                        >
                            See All Services >>
                        </p>
                    </nuxt-link>
