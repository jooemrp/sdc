<template>
    ...
    <section class="flex m-10 md:m-20" v-if="content.title">
        <div class="container grid-cols-3 mx-auto xl:grid">
            <div class="col-span-2">
                <div class="container mx-auto xl:p-0">
                    ...
                    <div class="flex mb-8">
                        <svg class="w-4 h-4 mt-2 mr-3" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 122.88 122.88" style="enable-background: new 0 0 122.88 122.88" xml:space="preserve">
                            <g>
                        ...
                        <p class="m-1 capitalize text-md text-neutral-600 md:leading-normal" >
                    ...
                    <SharedSocialShareButton class="mt-5" :url="currentURL" :text="`Baca artikel`" />
                </div>
            </div>
