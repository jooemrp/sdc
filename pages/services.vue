<template>
    ...
    >
        <div class="container text-center">
            ...
            <p
                class="mx-auto mb-5 mt-10 w-3/4 text-3xl leading-relaxed text-white"
            >
                Uncover the path to achieving your pharmaceutical goals with our
                proven digital marketing strategy, designed to maximize
                benefits. Explore our services below and embark on your journey
                to success
            </p>
        </div>
    </div>
    ...
    <div class="flex justify-center xl:my-10 xl:px-36">
        <div class="container m-5 grid-cols-2 gap-6 space-y-10 xl:grid">
            <div class="">
                <h2
            ...
            <div class="mx-auto">
                ...
                <ul class="mb-10 list-inside list-disc text-xl leading-relaxed">
    ...
    <div class="flex justify-center bg-sips-maroon">
        <div class="container m-5 mt-36 grid-cols-2 gap-6 text-white xl:grid">
            <div class="">
            ...
            <div class="mx-auto">
                <p class="mb-5 text-xl leading-relaxed">
                    ...
                    This program combines and bridge interaction between HCP and
        ...
        <div class="container m-5 mt-36 grid-cols-2 gap-6 text-white xl:grid">
            ...
            <div class="mx-auto">
                <p class="mb-5 text-xl leading-relaxed">
                    ...
                    competitive landscape. By employing a mix of qualitative and
                    quantitative research methods, we empower your company to
                    make informed decisions, optimize product development, and
    ...
    <div class="flex justify-center">
        <div class="container m-5 mt-36 grid-cols-2 gap-6 xl:grid">
            <div class="">
            ...
            <div class="mx-auto">
                <p class="mb-5 text-xl leading-relaxed">
                    ...
                    internal content management, educating your HCP
                    stakeholders, or as a simple corporate website, we are
                    available for your technology enhancement.
                </p>
                <p class="text-xl leading-relaxed">
                    - Website development for CMS, LMS, and Corporate Site
                    <br />- SEO Management <br />- Content Management <br />-
                    Creation of digitize content: videos, animations, e-books
                    and e-brochures
                </p>
            </div>
        </div>
