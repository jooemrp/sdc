        ...
        <div class="container grid-cols-2 gap-6 mx-5 xl:grid"
            ...
            data-aos-delay="300">
                ...
                >
                    ...
                    <li>
                        Creation of digitize content: videos, animations,
                        e-books and e-brochures
                    </li>
                </ul>
            </div>
        </div>
...
useSeoMeta({
    ...
    ogImage: '~/assets/img/services-at-sips-digital.webp',
    ...
    twitterImage: '~/assets/img/services-at-sips-digital.webp',
