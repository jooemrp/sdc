<template>
  ...
  >
    ...
    <p class="xl:text-xl max-w-6xl mx-auto text-white pt-5 leading-loose">
  ...
  <div class="container mx-auto mt-5">
    <div class="xl:grid grid-cols-2 space-y-10 m-5 xl:my-10">
      ...
      <div class="mx-auto">
        <h3 class="text-orange-500 text-4xl font-bold mb-4">SEO Audit</h3>
        <p class="text-xl">
      ...
      <div class="mx-auto">
        <h3 class="text-orange-500 text-4xl font-bold mb-4">On-Page SEO</h3>
        <p class="text-xl">
      ...
      <div class="mx-auto">
        <h3 class="text-orange-500 text-4xl font-bold mb-4">Local SEO</h3>
        <p class="text-xl">
  ...
  <div class="container mx-auto mt-5">
    <div class="xl:grid grid-cols-2 space-y-10 m-5 xl:my-10">
      ...
      <div class="mx-auto">
        <h3 class="text-rose-900 text-4xl font-bold mb-4">Content Strategy</h3>
        <p class="text-xl">
          We start by devising a content strategy that aligns with your business
          goals and audience's needs. This includes identifying key topics,
          content formats, and distribution channels.
        </p>
      </div>
      <div class="mx-auto">
        <h3 class="text-rose-900 text-4xl font-bold mb-4">Content Creation</h3>
        <p class="text-xl">
          Our team of skilled writers and designers produce high-quality
          content, from informative articles and engaging blog posts to
          eye-catching infographics and compelling videos.
        </p>
      </div>
      <div class="mx-auto">
        ...
        <p class="text-xl">
          We ensure your content reaches your target audience through the right
          channels. This could include your website, social media platforms,
      ...
      <div class="mx-auto">
        ...
        <p class="text-xl">
          We extend the reach of your content by sharing it on relevant social
          media platforms, fostering engagement and encouraging shares.
        </p>
      </div>
      <div class="mx-auto">
        <h3 class="text-rose-900 text-4xl font-bold mb-4">
        ...
        <p class="text-xl">
          We use analytics to monitor how your content is performing in terms of
          engagement, reach, and conversions. Based on these insights, we
          continually refine your content strategy for improved results.
        </p>
      </div>
      <div class="mx-auto">
        <h3 class="text-rose-900 text-4xl font-bold mb-4">
